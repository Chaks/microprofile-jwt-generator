...
public class TokenUtils {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String token = tokenUtils.generateTokenString("/jwtClaims.json", timeClaims);
   ...
   */
  public String generateTokenString(String jsonResName, Map<String, Long> timeClaims)
          throws Exception {
   ...
   * @throws Exception on parse failure
   */
  public String generateTokenString(PrivateKey pk, String kid, String jsonResName, Map<String, Long> timeClaims) throws Exception {
   ...
   * @throws Exception on decode failure
   */
  public PublicKey decodePublicKey(String pemEncoded) throws Exception {
    byte[] encodedBytes = toEncodedBytes(pemEncoded);
